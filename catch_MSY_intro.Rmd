...
# k is a list of the possible values of k, and the statistical distribution from which to draw them. By default, the values of r and k are drawn from a uniform distribution. Following Martell and Froese (for now), we choose values between the maximum catch in the time series, and 100 times the maximum catch.
...
# BSC_catchMSY <- catchmsy(year=year,catch=catch,l0=l0,lt=lt,sigv=0,k=k,r=r) (not run)
